...
export class RoleManagerService {
    ...
    async loadRoles() {
        ...
        try {
            const response = await firstValueFrom(this.http.get<any>(`${this.apiUrl}/roles`, { withCredentials: true }));
    ...
    async loadModulesForPermissions() {
        try {
            const response = await firstValueFrom(this.http.get<any>(`${environment.apiUrl}/catalogs/modules`, { withCredentials: true }));
